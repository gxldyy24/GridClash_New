 ...
 */
public class PasswordCreationPage extends Page {
	...
	private static final Logger LOG = 
			Logger.getLogger(PasswordCreationPage.class);
		...
		createAccountButton.addActionListener((e) -> {
			...
			try {
    			...
    			if (matchPassword() && isValidPassword(userPassword)) {
                    ...
                    boolean v = check.checkPassCreate(userPassword, 
	...
	/**
	 * Adds welcome and create account password label.
	 */
	...
	/**
	 * Adds updated user and welcome message label.
	 */
